...
### 1. Assignment 4.1: Local Multipass Infrastructure [Makefile](local/Makefile)
...
### 2. Assignment 4.2: Jetstream2 OpenStack Cloud [Makefile.jetstream](jetstream/Makefile.jetstream)
...
### 3. Assignment 4.3: Chameleon Cloud KVM@TACC [Makefile.chameleon](chameleon/Makefile.chameleon)
